...
//          taxCalc
//          01-25-2022 
//  taxCalc calculates and displays a
...
void taxCalc(){
    ...
    double netProfit = (grossProfit - totalTax); //net sales = gross profit - total tax
   
    cout <<"\n"; //line break for readability

    cout << "Gross Profit:" << ' ' << "$" << grossProfit << endl; //console output representing the gross total profit
    cout << "Net Profit:" << ' ' << "$" << netProfit << endl; //console output representing the net sales profit
